...
* **R104: Password recovery Form** `/recover_password`
* **R105: Password recovery Action** `/recover_password`
...
<table>
    ...
    <tr>
		<td>401 Unauthorized <!--homepage --></td>
        <td>Error. The posted details were incorrect.</td>
	</tr>
    <tr>
		<th>Response Body</th>
		<td colspan="2"><a href="#JSON101-Login-Status">JSON101</a></td>
	</tr>
    <tr>
		<th>Permissions</th>
		<td colspan="2">PUB</td>
...
<table>
	...
	<tr>
		<td>409 Conflict</td>
        <td>Error. There's already an account with the passed email/username.</td>
	</tr>
    <tr>
		<th>Response Body</th>
		<td colspan="2"><a href="#JSON102-Register-Status">JSON102</a></td>
	</tr>
    <tr>
		<th>Permissions</th>
		<td colspan="2">PUB</td>
...
<table>
	<tr>
		<th>URL</th>
		<td colspan="2">/recover_password</td>
	</tr>
    <tr>
		<th>Description</th>
	...
	<tr>
		<th rowspan=1>UI</th>
		<td colspan="2"><a href="https://hackmd.io/QVhi-MLfTICAoxlvrpjgrQ?view#UI08-Recover-Password">UI08</a></td>
	</tr>
    <tr>
...
* **R207: Edit Password Action** `/user/password`
...
<table>
    ...
    <tr>
		<td>+new_password_confirm: string</td>
...
<table>
	...
	<tr>
		...
		<td>?query: string</td>
        <td>Search field for post name/content.</td>
	</tr>
	<tr>
		<th>UI</th>
...
<table>
    ...
    <tr>
		<th rowspan="3">Returns</th>
		<td>200 OK</td>
        <td>The vote was successfully added.</td>
	</tr>
    <tr>
		<td>400 Bad Request</td>
        <td>Error. The posted details were incomplete.</td>
    ...
    <tr>
		<td>404 Not Found</td>
        <td>Error. Could not find a post with the provided id.</td>
	</tr>
    <tr>
		<th>Permissions</th>
		<td colspan="2">USR</td>
...
<table>
    ...
    <tr>
		<th rowspan="3">Returns</th>
		<td>200 OK</td>
        <td>The vote was successfully removed.</td>
	</tr>
    <tr>
		<td>400 Bad Request</td>
        <td>Error. The posted details were incomplete.</td>
...
* **R402: Add University Action** `/university`
* **R403: Edit University Form** `/university/{id}/edit`
* **R404: Edit University Action** `/university/{id}/edit`
* **R405: Delete University** `/university/{id}`
* **R406: Add Faculty Form** `/faculty`
* **R407: Add Faculty Action** `/faculty`
* **R408: Edit Faculty Form** `/faculty/{id}/edit`
* **R409: Edit Faculty Action** `/faculty/{id}/edit`
* **R410: Delete Faculty** `/faculty/{id}`
* **R411: Add City Form** `/city`
* **R412: Add City Action** `/city`
* **R413: Edit City** `/city/{id}/edit`
* **R414: Edit City** `/city/{id}/edit`
* **R415: Delete City** `/post/{id}`
...
* **R606: 403** `/403`
* **R607: Homepage** `/index`
* **R608: Homepage Authenticated (Feed)** `/index`
...
<table>
	...
	<tr>
		<th>UI</th>
		<td colspan="2"><a href="https://hackmd.io/QVhi-MLfTICAoxlvrpjgrQ#UI03-FAQ">UI03</a></td>
	</tr>
    <tr>
		<th>Permissions</th>
		<td colspan="2">PUB</td>
