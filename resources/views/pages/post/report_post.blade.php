{{Log::info("serving report post page")}}

@extends('layouts.app')

@section('title', 'Vecto: Flag Post')
...
<div class="container">
	<div class="jumbotron">
		<h1>Report post</h1>
		<h4>We are sorry that something on this post is offensive or inapropriate. Please tell us the reason why you are reporting it!</h4>
