			...
			<div class="container">
				<div class="row pb-3 bg-faded">
					...
					<div class="text-center col-sm col-lg-8">
                    	<i class="fas fa-map-marker-alt"></i> <a href="{{ url('/post/search?university_to='.$post->faculty_to->university->id.'&faculty_to='.$post->faculty_to->id) }}">{{$post->faculty_to->name}},{{$post->faculty_to->university->name}}</a>
					</div>
					<div class="text-center col-sm col-lg-2">
