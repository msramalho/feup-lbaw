                ...
                <form id="editUniForm">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input id="name" type="text" class="form-control form-control-lg" name="name" placeholder="University official name" value="{{$university->name}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="editUniDescription">University public description <span class="text-danger">*</span></label>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6 col-sm-12">
                            ...
                            <select id="uniCountry" class="custom-select" name="country_id" required>
                        ...
                        <div class="form-group col-lg-3 col-md-6 col-sm-12">
                            ...
                            <input id="uniSubmit" type="submit" class="btn btn-primary form-control" value="Save" />
                        </div>
                    </div>
                </form>
            </div>
